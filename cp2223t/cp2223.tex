...
\\[\blanklineskip]%
\>[B]{}\Varid{f1}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\mathrm{0}\mathrel{=}\mathrm{0}{}\<[E]%
\\
\>[B]{}\Varid{f1}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\mathrm{1}\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[B]{}\Varid{f1}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\mathrm{2}\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[B]{}\Varid{f1}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{n}\mathrel{=}\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;(\Varid{n}\mathbin{-}\mathrm{3}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\;\Varid{x}\;\Varid{y}\;\Varid{z}\;\mathrm{0}\mathrel{=}\Varid{a}\mathbin{*}\Varid{f1}\;\Varid{x}\;\Varid{y}\;\Varid{z}\;\mathrm{2}\mathbin{+}\Varid{b}\mathbin{*}\Varid{f1}\;\Varid{x}\;\Varid{y}\;\Varid{z}\;\mathrm{1}\mathbin{+}\Varid{c}\mathbin{*}\Varid{f1}\;\Varid{x}\;\Varid{y}\;\Varid{z}\;\mathrm{0}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g}\;\Varid{x}\;\Varid{y}\;\Varid{z}\;\Varid{m}\mathrel{=}\Varid{g}\;\Varid{x}\;\Varid{y}\;\Varid{z}\;(\Varid{m}\mathbin{-}\mathrm{1})\mathbin{+}\Varid{x}\mathbin{*}\Varid{f1}\;\Varid{x}\;\Varid{y}\;\Varid{z}\;(\Varid{n}\mathbin{-}\Varid{m}\mathbin{-}\mathrm{2})\mathbin{+}\Varid{y}\mathbin{*}\Varid{f1}\;\Varid{x}\;\Varid{y}\;\Varid{z}\;(\Varid{n}\mathbin{-}\Varid{m}\mathbin{-}\mathrm{1})\mathbin{+}\Varid{z}\mathbin{*}\Varid{f1}\;\Varid{x}\;\Varid{y}\;\Varid{z}\;(\Varid{n}\mathbin{-}\Varid{m}){}\<[E]%
\ColumnHook
...
\\[\blanklineskip]%
\>[B]{}\mbox{\commentbegin  teste a b c 0 = 0  \commentend}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\commentbegin  teste a b c (n+1) =   \commentend}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{4}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment gene = undefined}{}\<[E]%
\\
\>[B]{}\Varid{gene}\mathrel{=}(\Varid{id}+\Varid{separa})\comp \Varid{out}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{separa}\;(\Varid{a},\Varid{b})\mathrel{=}(\Varid{a},(\Varid{groupBy}\;(\mathbin{\char92 \char95 }\Varid{y}\to \Varid{nivelIdent}\;\Varid{y}\mathbin{>}\Varid{identPai})\;\Varid{b})){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\mathbf{where}\;\Varid{identPai}\mathrel{=}\mathrm{1}\mathbin{+}\Varid{nivelIdent}\;\Varid{a}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{paraPar}\;\Varid{a}\;\Varid{b}\mathrel{=}(\Varid{a},\Varid{b}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{nivelIdent}\;\Varid{l}\mathrel{=}\Varid{contaEspacos}\;\Varid{l}\div \mathrm{4}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{contaEspacos}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}\mathrm{0}{}\<[E]%
\\
\>[B]{}\Varid{contaEspacos}\;(\Varid{h}\mathbin{:}\Varid{t})\mathrel{=}\mathbf{if}\;(\Varid{h}\not\equiv \text{\ttfamily '~'})\;\mathbf{then}\;\mathrm{0}\;\mathbf{else}\;\mathrm{1}\mathbin{+}\Varid{contaEspacos}\;\Varid{t}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
